...
{
    /// <summary>
    /// Road of Gold is the functional Portal for the player
    /// Road of King is just to display a visual pair for the Road of Gold
    /// </summary>
	public class RoadOfGoldPlayer : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] > -1)
            {
                ...
                {
                    Projectile.ai[1] = -1;
                    if (Projectile.ai[2] == 0 && Projectile.ai[1] == -1)
                    {
                        if (Projectile.timeLeft > 10)
                            Projectile.timeLeft = 10;
                    }
            ...
            else if (Projectile.ai[1] == -2 && Projectile.timeLeft > 15)
            {
                Projectile.Center = Main.player[Projectile.owner].Center + new Vector2(16 * Main.player[Projectile.owner].direction, 0);
            }
        }
